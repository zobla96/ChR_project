...
public:
	...
	//=======Get inlines=======
	_NODISCARD inline double GetLayerTotalEnergy(const G4Track*) const;
	_NODISCARD inline double GetLayerDeltaEnergy(const G4Track*) const;
	_NODISCARD inline double GetLayerStep(const G4Track*) const;
	//=======Inlines=======
...
private:
	...
	//for this project, only deltaE and stepLng are used... for dosimetry it would be nice to go with totalE.
	//Still, keeping it as std::tuple with totalE for some other projects, so I could just copy/paste
