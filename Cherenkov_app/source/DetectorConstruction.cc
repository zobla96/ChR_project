...
m_radiatorAngle(22.0 * deg),
m_radiatorThickness(100. * um),
m_detectorRadius(35. * um),
m_detectorAngle(59.5 * deg),
m_detectorDistance(37.6 * cm) {
...
void DetectorConstruction::LoadWorld() {
	...
	p_worldPhys = new G4PVPlacement{ nullptr, G4ThreeVector(0.,0.,0.), worldLogic, "worldPhys", nullptr, false, 0, true };
...
void DetectorConstruction::LoadRadiator() {
...
#endif // !standardRun
	G4Tubs* radiatorSolid = new G4Tubs{ "radiatorSolid", 0., 3. * cm, m_radiatorThickness, 0., CLHEP::twopi };
	...
	G4VPhysicalVolume* radiatorPhys = new G4PVPlacement{ radTransform, "radiatorPhys", radiatorLogic, p_worldPhys, false, 0, true };
...
void DetectorConstruction::LoadDetector() const {
	...
	G4Tubs* detectorSolid = new G4Tubs{ "detectorSolid", 0., m_detectorRadius, detThickness, 0., 360. * deg };
	//
	...
	*/
	...
	new G4PVPlacement{ detTransform, "detectorPhys", p_detectorLogic, p_worldPhys, false, 0, true };
}
