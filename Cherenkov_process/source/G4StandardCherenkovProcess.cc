...
G4StandardCherenkovProcess::G4ChRPhysicsTableVector G4StandardCherenkovProcess::fChRPhysDataVec{};
unsigned int G4StandardCherenkovProcess::fNoOfBetaSteps = 20;
...
: G4VDiscreteProcess(name, fElectromagnetic),
  ...
  fChRProcessMessenger(new G4StandardChRProcess_Messenger{ this }),
  fUseEnergyLoss(false)
{
...
G4VParticleChange* G4StandardCherenkovProcess::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
  ...
  if (fChRPhysDataVec[materialID].fAroundBetaValues.front().fValuesCDF) {
...
void G4StandardCherenkovProcess::BuildPhysicsTable(const G4ParticleDefinition&)
{
  ...
  if (fChRPhysDataVec.size() == numOfMaterials)
    return;
  fChRPhysDataVec = G4ChRPhysicsTableVector{}; //in case some materials were deleted - rebuilding all physics tables
  fChRPhysDataVec.reserve(numOfMaterials);
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//=========protected G4StandardCherenkovProcess:: methods=========
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
